...
<table class ="table table-striped">
  ...
  <tr>
    <th>이 름</th>	
    <td><input type="text" name="userName" value="<%=StringUtil.nvl(bb.getUserName(), user_name) %>" readOnly /></td>
  </tr>
  <tr>
    <th>제 목</th>	
    <td><input type="text" name="title" value="<%=bb.getTitle() %>" maxlength="15"></td>
  </tr>

  <tr>
    <th>내용</th>
    <td><input type="text" name="content" value="<%=bb.getContent() %>" ></td>
  </tr>
