...
<script type="text/javascript">
	...
	function mycontent() {
		location.href = 'addrbook_control.jsp?action=list2';
	}
</script>
...
[<%=user_id %>]님 환영합니다!! 
<br>
<input type="button" value="내 글 목록 보러가기" class="submit-btn" onclick="mycontent()"> 
<div style="text-align:legt; margin-right:10px;"> 
</div>
<div style="text-align:right; margin-right:10px;">
	...
	<input type="button" class="submit-btn" value="검색" onclick="fn_search()" />
</div>
